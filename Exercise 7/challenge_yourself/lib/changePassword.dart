...
class ChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ChangeFormWidget(oldPassword: oldPassword));
  }
}

class ChangeFormWidget extends StatefulWidget {
  ChangeFormWidget({Key? key, this.oldPassword}) : super(key: key);

  String? oldPassword;
  @override
  _ChangeFormWidgetState createState() => _ChangeFormWidgetState();
}

class _ChangeFormWidgetState extends State<ChangeFormWidget> {
